package com.dailynews.android.view;
...
/**
 * Created by sunfeiswag on 2018/2/23.
 */
...
public class LauncherView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //矩形轮廓,圆弧在内部，并设置一定的内边距
        RectF rectF1 = new RectF(mBorderWidth1/2 + dipToPx(8),
                mBorderWidth1/2 + dipToPx(8),
                getWidth() - mBorderWidth1/2 - dipToPx(8),
                getWidth() - mBorderWidth1/2 - dipToPx(8));
        //画圆弧 参数1：矩形轮廓 参数2：起始位置 参数3：扫过的范围，初始为0 参数4：是否连接圆心
        canvas.drawArc(rectF1, 90, mCurrentRadian, false, mPaint1);
        //矩形轮廓
        RectF rectF2 = new RectF(mBorderWidth2/2,
                mBorderWidth2/2,
    ...
    private int dipToPx(float dip){
         ...
         * context.getResources().getDisplayMetrics()这是获取手机屏幕参数，后面的density就是屏幕的密度。
         */
